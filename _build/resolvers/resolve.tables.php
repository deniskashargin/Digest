...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('digest_core_path', null, $modx->getOption('core_path') . 'components/digest/') . 'model/';
            $modx->addPackage('digest', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/digest/model/schema/digest.mysql.schema.xml';
